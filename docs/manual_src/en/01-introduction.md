...
- **GVL and GC awareness**: In wall mode, rperf tracks time spent blocked off the GVL, waiting to reacquire the GVL, and in GC marking/sweeping phases — each as distinct [synthetic frames](#index:synthetic frames).
